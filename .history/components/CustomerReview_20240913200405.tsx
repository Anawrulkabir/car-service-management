      ...
      <div className="md:flex md:justify-evenly md:space-x-2 space-y-2 mx-auto mt-10">
        <div className="w-1/3 items-center content-center border border-gray-500 rounded-2xl space-y-4 p-3">
          ...
          <p className="items-center content-center">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore quam eos voluptates beatae? Quam placeat sed temporibus laboriosam quibusdam repellat architecto accusantium aut, consequatur aliquam molestias in vitae iste provident? lo
          </p>
        </div>
        <div className="w-1/3 items-center content-center border border-gray-500 rounded-2xl space-y-4 p-3">
          <div className="">
