...
const HomePageAhosanPart = () => {
  return (
    <div>
      <div>
        <div className="bg-[url('https://i.ibb.co.com/hff1pZs/Untitled-2.jpg')]">
          <div className="flex">
            <Image
              src="https://i.ibb.co.com/hff1pZs/Untitled-2.jpg"
              alt="image"
              width={500}
              height={300}
            />
            <Image
              src="https://i.ibb.co.com/pL6TqFf/Untitled3.jpg"
              alt="image"
              width={500}
              height={300}
            />
