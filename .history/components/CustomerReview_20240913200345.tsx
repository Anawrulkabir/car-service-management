      ...
      <div className="md:flex md:justify-evenly md:space-x-2 space-y-2 mx-auto mt-10">
        <div className="w-1/3 items-center content-center border border-gray-500 rounded-2xl space-y-4 p-3">
          ...
          <p className="items-center content-center">
            Car Reapir  library is an absolute gem in our community! The staff
            ...
            you into classic literature or the latest bestsellers, you sure to
            find something captivating here. I love spending my afternoons
            getting lost in the pages of their wonderful books.
          </p>
        </div>
        <div className="w-1/3 items-center content-center border border-gray-500 rounded-2xl space-y-4 p-3">
          <div className="">
